"""Upstream resilience regressions: review retry (timeout/429), 402 fast-fail, review fallback."""
...
from services.translation.llm.providers.deepseek import transport as _transport
from services.translation.services.continuation import review as _review
