...
pub fn public_request_payload(spec: &ResolvedJobSpec) -> PublicResolvedJobSpec {
    PublicResolvedJobSpec {
        ...
        translation: PublicTranslationInput {
            ...
            url: spec.translation.url.clone(),
            temperature: spec.translation.temperature,
            top_p: spec.translation.top_p,
            timeout_seconds: spec.translation.timeout_seconds,
            max_retries: spec.translation.max_retries,
            reasoning_effort: spec.translation.reasoning_effort.clone(),
            options: spec.translation.options.clone(),
